          ...
          <Table striped bordered hover>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{Array.isArray(patient.riskFactors.hospitalAcquiredConditions) && patient.riskFactors.hospitalAcquiredConditions.length > 0 ? 
     patient.riskFactors.hospitalAcquiredConditions.join(", ") : "None"}</td>
